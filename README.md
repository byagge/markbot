...
Telegram Bot API не отдаёт подарки и био других пользователей — оценка строится на доступных данных + эвристики. В интерфейсе есть предупреждение о приватности.
